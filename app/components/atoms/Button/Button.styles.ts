...
export const buttonStyles = tv({
  base: 'flex items-center gap-2 rounded-sm px-4 py-2.5 transition-colors disabled:cursor-not-allowed disabled:opacity-60',
  variants: {
    intent: {
      ...
      strong: `[--faded-hover:theme('colors.gray.300')] [--faded:theme('colors.gray.200')] [--hover:theme('colors.gray.800')] [--main:theme('colors.gray.700')] [--outline-hover:theme('colors.gray.50')]`,
    },
    size: {
      sm: 'text-sm',
      md: 'text-base',
    ...
    variant: {
      ...
      ghost: 'border border-transparent bg-transparent text-[--main] hover:text-[--hover]',
